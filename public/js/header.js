document.addEventListener("DOMContentLoaded", function () {
    ...
    function addActive(items) {
      ...
      console.log("Adding active class to item:", items[currentFocus], "with classes:", items[currentFocus].className, "computed style:", window.getComputedStyle(items[currentFocus]).backgroundColor); // Enhanced debug
